...
- [Units Support](https://mendeleev.readthedocs.io/en/stable/units.html) - Working with physical units (v1.3.0+)
...
### Units Support (v1.3.0+)

Since version 1.3.0, mendeleev integrates with [pint](https://pint.readthedocs.io/) to provide
...
@misc{mendeleev2014,
   author = {Mentel, Łukasz},
   title = {mendeleev} -- A Python resource for properties of chemical elements, ions and isotopes, ver. 1.3.0},
